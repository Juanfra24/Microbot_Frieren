...
|------|-----------------|----------------|-----------------|
| 2026-05-21 | 2.6.2 | 173 | Game revision 2026-05-13 rev238, RuneLite 1.12.25→1.12.26→1.12.27-SNAPSHOT, Walker hardening + A* Chebyshev heuristic + MoA League 6 teleports, antiban fatigue-aware timing + log-normal delays, AgentServer Unix-socket + quest-helper endpoints + hot-reload, StateMachineScript framework, detection hardening phases 1-7, Rs2HuntKit, League transport lock catalog |
| 2026-05-02 | 2.5.2 | 48 | Game revision update 2026-4-15 (GameVals, Legacy IDs, Item variations, Widget IDs, Scripts), RuneLite 1.12.24 release + 1.12.25-SNAPSHOT bump, AgentServer auth token handling, queryable terminal guardrail (OnClientThread enforcement), tab index refactor (map-based selection), telemetry CPU removal, POH walker unblock, deposit box container ID fix, pathfinder fairy ring null handling |
| 2026-04-21 | 2.5.2 | 28 | Game revision update 2026-4-15 (GameVals, Legacy IDs, Item variations, Widget IDs, Scripts), RuneLite 1.12.24 release + 1.12.25-SNAPSHOT bump, AgentServer auth token handling, CPU telemetry removal from error reports, InterfaceTab refactor (map-based tab selection), POH walker / nexus portal fixes, deposit box container ID fix, pathfinder null fairy ring retry |
| 2026-04-12 | 2.4.0 | 151 | Quest helper auto-obtain missing items + ironman guard, pathfinder packed-int set optimisation + null transport skip, OnClientThread queryable guardrail + scanner, version bump 2.2.0→2.2.1→2.2.4→2.3.9→2.4.0, ShortestPath new transport TSVs (hot air balloons, magic mushtrees, seasonal), seasonal_transports collision map update |
