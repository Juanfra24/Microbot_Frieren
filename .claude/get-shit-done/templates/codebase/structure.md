...
- Usage: Reference from command with `@C:/Users/Juanfra/projects/Microbot_Frieren/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/Juanfra/projects/Microbot_Frieren/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/Juanfra/projects/Microbot_Frieren/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
