...
```bash
INIT=$(node "C:/Users/Juanfra/projects/Microbot_Frieren/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Juanfra/projects/Microbot_Frieren/.claude/get-shit-done/templates/spec.md.
