...
```
Agent(
  prompt="Read C:/Users/Juanfra/projects/Microbot_Frieren/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Juanfra/projects/Microbot_Frieren/.claude/get-shit-done/templates/VALIDATION.md`
