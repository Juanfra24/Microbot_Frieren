...
INSTALL_JS_GLOBAL="C:/Users/Juanfra/projects/Microbot_Frieren/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Juanfra/projects/Microbot_Frieren/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
